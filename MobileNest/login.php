...
/**
 * 🔐 PROSES LOGIN DENGAN DIFERENSIASI ADMIN & USER
 * 
 * Flow:
 * 1. Cek credentials di tabel users
 * 2. Jika valid, cek apakah user ada di tabel admin
 * 3. Jika ada di tabel admin → LOGIN AS ADMIN
 * 4. Jika tidak ada di tabel admin → LOGIN AS USER
 */
        ...
        if (!$stmt) {
            ...
            if ($result->num_rows > 0) {
                ...
                if (password_verify($password, $user_data['password'])) {
                    ...
                    // 3️⃣ CEK TABEL ADMIN (KUNCI DIFERENSIASI ROLE)
                    ...
                    if (!$admin_stmt) {
                        ...
                        if ($admin_result->num_rows > 0) {
                            // ✅ ADALAH ADMIN - SET SESSION ADMIN
                            ...
                            // ✅ ADALAH REGULAR USER - SET SESSION USER
